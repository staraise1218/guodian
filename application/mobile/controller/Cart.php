...
class Cart extends Base {
    ...
    public function cart2(){
        ...
        $this->assign('buy_method', $buy_method); // 物流公司
        return $this->fetch();
    }

    public function buy_method(){

        $buy_method = input('buy_method');

        $this->assign('buy_method', $buy_method);
        return $this->fetch();
    }
    ...
    public function cart3(){
        ...
        if(!$address_id && $buy_method == '2') exit(json_encode(array('status'=>-3,'msg'=>'请先填写收货人信息','result'=>$car_price))); // 返回结果状态
