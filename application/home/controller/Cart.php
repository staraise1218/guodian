...
class Cart extends Base {
    ...
    public function cart3(){
        ...
        $buy_method = input("buy_method"); // 立即购买
        ...
        if ($_REQUEST['act'] == 'submit_order') {
            ...
            $result = $orderLogic->addOrder($this->user_id,$address_id,$shipping_code,$invoice_title,$coupon_id,$car_price,$user_note,$pay_name, $buy_method); // 添加订单
